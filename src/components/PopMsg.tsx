...
export function PopMsg(){
    ...
    return (
        ...
        className={`
           cursor-pointer absolute bottom-1/12 right-1/2 translate-x-1/2 border p-3 rounded-lg z-3 ${color[msgType||"normal"]} ${show?"opacity-100 translate-x-0 animate-bounce" : "opacity-0 translate-x-100"} duration-700
        `}>
